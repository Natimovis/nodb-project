...
export default class Home extends Component {
    ...
    render() {
        return (<div className="about">
            ...
            <h2>3. Your Plan</h2>
            <p>This section will be the cornerstone of your success if implemented properly. A lot of people are confused when it comes to what is considered a "healthy diet".
                This section will clear that up and give you the sort of personalized eating recommendations that you would typically recieve from a doctor, nutritionist, or dietican.   </p>
                </div>
            </div>
        )
    }
